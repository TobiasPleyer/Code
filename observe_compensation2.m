...
%% Fit Polynomials to the phase
    ...
    % built in `fminsearch`.
%     [solution,val] = make_fourier_fit(fit_w_Sk,fit_I_Sk,fit_p_Sk,Int_F,p4);
%     [solution,val] = make_fourier_fit(w_Sk,I_Sk,filtered_p_Sk,Int_F,p4);
%     fprintf('The optimization leads to %2.2f percent of the Fourier limit.\n',(1-val)*100)
    [solution,val] = fminsearch(@(x)observe_compensation_min_Func( ...
        x,w_Sk,I_Sk,filtered_p_Sk,l_Sk*1e-9,Int_F,p4),p4);
