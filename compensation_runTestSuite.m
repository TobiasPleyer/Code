...
figure(figNum)
    ...
    xlabel('TOD','fontweight','bold','fontsize',16);
    ylabel('GDD','fontweight','bold','fontsize',16);
    zlabel('Achieved minimum value (1-max(abs(E))','fontweight','bold','fontsize',16);
    title('Test 3: Calcultated values of our minimization function 2D case','fontweight','bold','fontsize',16);
...
figure(figNum)
    ...
    ylabel('GDD','fontweight','bold','fontsize',16);
    zlabel('Achieved minimum value (1-max(abs(E))','fontweight','bold','fontsize',16);
    title('Test 4: Calcultated values of our minimization function 2D case','fontweight','bold','fontsize',16);
